...
* 备  注：
******************************************************************************/
INI_RES IniUtil::OpenFile(const char* pathName, const char* type)
{
...
* 备  注：
******************************************************************************/
INI_RES IniUtil::GetKey(const char* mAttr, const char* cAttr, char* pValue)
{
...
* 备  注：
******************************************************************************/
int IniUtil::GetInt(const char* mAttr, const char* cAttr )
{
 int nRes = 0;
...
* 备  注：
******************************************************************************/
char *IniUtil::GetStr(const char* mAttr, const char* cAttr )
{
 memset( m_szKey,0,sizeof(m_szKey) );
